...
namespace TemasDasnet
{
    public static class TemaColores
    {
        ...
        //tema Dark
        private static readonly Color PanelPadreDa = Color.FromArgb(84, 88, 106);
        private static readonly Color PanelBotonesDa = Color.FromArgb(200, 188, 214);
        private static readonly Color BarraTituloDa = Color.FromArgb(35, 10, 125);
        private static readonly Color TextBusquedaDa = Color.FromArgb(0, 0, 0);
        private static readonly Color FuenteIconosDa = Color.White;
        ...
        public static void ElegirTema(string Tema)
        {
            ...
            if (Tema == "Dark")
            {
                PanelPadre = PanelPadreDa;
                PanelBotones = PanelBotonesDa;
                BarraTitulo = BarraTituloDa;
                TextBusqueda = TextBusquedaDa;
                FuenteIconos = FuenteIconosDa;
            }
            if (Tema == "Morado")
            {
